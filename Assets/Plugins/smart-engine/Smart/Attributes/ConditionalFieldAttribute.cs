...
namespace Smart.Attributes.Internal
{
	...
	public class ConditionalFieldAttributeDrawer : PropertyDrawer
	{
		...
		private void Initialize(SerializedProperty property)
		{
			...
			{
				if (_allPropertyDrawersInDomain != null && _allPropertyDrawersInDomain.Keys.Count > 0) return;
			...
			void TryGetCustomAttributeDrawer()
			{
				...
				var customAttributeData =
					fieldInfo.GetCustomAttributesData().FirstOrDefault(a => a.AttributeType == secondAttribute.GetType());
	...
	public static class ConditionalFieldUtility
	{
		...
		public static bool BehaviourPropertyIsVisible(Object obj, string propertyName, ConditionalFieldAttribute appliedAttribute)
		{
